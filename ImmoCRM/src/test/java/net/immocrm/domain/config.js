function parse_strxy(o,n){
var i,e,c,u,a,t,r,s,l,k,d,p,h,f,g,m=String(o).replace(/^&/,"").replace(/&$/,"").split("&"),v=m.length,b=function(o){
	return decodeURIComponent(o.replace(/\+/g,"%20"));
for(n||(n=this.window),i=0;
v>i;
i++){
	for(k=m[i].split("="),d=b(k[0]),p=k.length<2?"":b(k[1]);
" "===d.charAt(0);
)d=d.slice(1);
...
for(f.length||(f=[d]),e=0;
e<f[0].length&&(l=f[0].charAt(e),(" "===l||"."===l||"["===l)&&(f[0]=f[0].substr(0,e)+"_"+f[0].substr(e+1)),"["!==l);
e++);
for(t=n,e=0,g=f.length;
g>e;
e++)if(d=f[e].replace(/^['"]/,"").replace(/['"]$/,""),r=e!==f.length-1,a=t,""!==d&&" "!==d||0===e)t[d]===s&&(t[d]={
...
!function(o,n){
	function i(n,i){
		...
		function e(i){
			...
			o.each(n.less,
				function(n,t){
					if(!u){
						...
						r.length 
						&& (o
							.less.getCSS(t.source,{id:t.target,variables:i.variables,compress:!0})
							.done(function(n) {
			...
			k.trigger("hide"),
			setTimeout(function(){
				s[0].contentWindow.postMessage("customizer-update",location.origin)
			}
			,150)),
			f.trigger(a?"hide":"show","The current theme is not customizable.")
		}
		...
		o.each(n.styles,function(i,e){
			p.push({
				name:i,config:n.config,config_vars:n.config_vars,variables:o.less.getVars(e)
			})
		}),
		u.customizer({
			styles:p,updating:function(o,n){
				r.toggle("default"!=n.name),h.hide(),s.css("visibility","hidden"),l.show()
			},
			updated:function(n,i){
				var a;
				
				i.fonts="",o("option[data-url]:selected",u).each(function(){
					(a=o(this).data("url"))&&-1===i.fonts.indexOf("'"+a+"'")&&(i.fonts+="@import '"+a+"'; \n")
				}
				),e(c=i)
			}
		}),
		...
		k.on({
			show:function(n,i){
				k.html(o.mustache('<h1 class="uk-h3">LESS {	{	type	}	}	 Error</h1><p>{ {	message	}		}	</p>',i)).show(),s.css("visibility","hidden")
			},
			hide:function(){
				k.hide(),s.css("visibility","visible")
			}
		})
		,f.on({
show:function(o,n){
...
name:e,config:n.config,config_vars:n.config_vars,variables:o.extend({
...
config:n.config,variables:o.less.getVars(n.styles[c]),groups:""
}
...
function e(n,i){
k=!1;
var e=o.Deferred(),c=[],u=0;
return o.each(n.styles,function(i,e){
o.each(n.less,function(o,n){
c.push({
target:("default"!=i?"/styles/"+i:"")+n.target,less:n.source+"\n"+e,css:"",error:""
}
)
}
)
...
"string"==o.type(t)?c[u].css=t:c[u].error=t,c[u].css=o.less.rewriteUrls(c[u].css,n.baseurl+c[u].target),o.isFunction(i.progress)&&i.progress.call(this,c[u],u,u/c.length*100),c[++u]&&!k?setTimeout(function(){
o.less.getCSS(c[u].less,i).always(a)
}
,150):e[k?"reject":"resolve"](c)
}
...
function u(i){
var e=i.find(".tm-sidebar ul"),c=i.find(".tm-main");
...
var n=o(this),e=n.data("position"),c=""===u||u===e;
n[c?"show":"hide"](),c&&(n.find("tr[data-widget-name]").each(function(){
var n=o(this),e=n.data("widget-name"),c=""===i||-1!==e.toLowerCase().indexOf(i.toLowerCase());
n.toggle(c)
}
...
n.preventDefault();
var i=o(this),e=i.offset(),c=e.top+i.height()+15;
...
function u(n){
if(n&&!o('option[value="'+n+'"]',l).length){
var e=o(i).clone(!0);
t(e,n),o(i).parent().children("[data-layout]:last").after(e),l.append('<option value="'+n+'">'+n+"</option>").val(n).trigger("change"),o("[data-assignment]",e).show()
}

}
function a(n,i){
i&&n!==i&&!o('option[value="'+i+'"]',l).length&&(t(o('[data-layout="'+n+'"]'),i),l.find('option[value="'+n+'"]').attr("value",i).html(i))
}
function t(o,n){
var i=o.data("layout");
o.attr("data-layout",n).find('[name^="'+k+"["+i+']"]').attr("name",function(o,e){
return e.replace(k+"["+i+"]",k+"["+n+"]")
}
)
}
function r(n){
o('[data-layout="'+n+'"]').remove(),l.find('option[value="'+n+'"]').remove().end().trigger("change")
}
var s=o(n),l=o("[data-layout-selector]",s),k=s.data("field-name"),d=o("[data-action=rename], [data-action=remove]",s),p=o("[data-assignment]",s);
...
function d(n){
b.each(function(){
var i=o(this),e=i.val(),c=[];
o.each(n.styles,function(o){
"default"!=o&&c.push(o)
}
),c=o.merge(["default"],o.merge(c,i.data("style-css")).sort()),i.html(o.mustache('{
{
#styles
}
...
var p=o("#config"),h=o.UIkit.modal("#compilemodal",{
bgclose:!1
}
),f=h.element.find(".uk-progress-bar"),g=h.element.find(".file-name"),m=h.element.find(".error-list"),v=o("[data-customizer]"),b=o("[data-style-selector]",p);
if(t("#layout",'[data-layout="default"]'),s(o("#menus",p)),u(p),a("#widgets"),r("[data-list-devices]"),h.element.find("button").on("click",function(){
c(),h.hide()
}
),l()?o("[href=#compile]").on("click",function(o){
...
),d(c),f.css("width","0%"),m.html(""),g.html(""),h.show(),e(o.extend({
}
,c,{styles:r
}
),{
...
url:n.config,cache:!1,dataType:"json"
}
).done(function(e){
var c=o.extend({
...
,n.config_vars);
n.config=e,n.groups=[],n.variables=n.variables||{

}
,n.matchName=u,o.each(n.config.groups,function(i,e){
var a,t={
label:e.label,variables:[],advanced:e.advanced||!1,more:!1
}
;
o.each(e.vars,function(i,e){
o.each(c,function(o,i){
u(e,o)&&(delete c[o],a={
name:o,"default":i,placeholder:i,label:o.replace(/^@/,"").replace(/^\w+\-/,"").replace(/\-/g," "),more:-1!==i.indexOf("@"),value:function(){
...
var i,e,c=o(this),a=c.val()||c.data("default");
-1===c.attr("data-default").indexOf("@")&&o.each(n.config.controls,function(n,t){
o.each(t.vars,function(n,r){
if(u(r,c.attr("data-name")))switch(t.type){
case"color":var s=o('<div class="sp-placeholder"><div class="sp-placeholder-color"></div></div>').find("div").css("background-color",a).end().on("click",function(){
var n;
c.spectrum({
showInput:!0,showAlpha:!0,color:a,change:function(o){
...
c.hide().after(s);
break;
case"font":e=[],o.isArray(t.options)?e.push({
group:"",options:t.options
}
...
break;
case"select":i=o(o.mustache('<select>{
{
#options
}
...
var a,t=o(i.select,n),r=o(i.sidebar,n),s=o(i.advanced,n),l=o(i.error,n);
n.on({
...
l.html(o.mustache('<h1 class="uk-h3">Error</h1><p>{
{
message
}
...
,updating:i.updating,updated:i.updated
}
...
i.preventDefault();
var e=o(this).attr("data-name"),c=o(this).val();
...
var e={
updating:o.noop(),updated:o.noop(),select:"select[name=style]",advanced:"input[name=advanced]",sidebar:"section.cm-sidebar-content",error:".cm-error",template:{
select:'{
{
#styles
}
...
',sidebar:'<div class="cm-vars cm-form uk-form">                             {
{
#groups
}
...
</label>                                     <div class="uk-form-controls">                                         <input class="uk-form-small" name="vars" type="text"{
{
#value
}
